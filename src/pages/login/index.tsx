...
// ** Redux Imports
import { loginWithEmailOTP } from "../../features/user/userSlice";
import { useAppDispatch, useAppSelector } from "../../features/user/store";
...
export default function Login() {
  ...
  const handleSignIn = async () => {
    if (email) {
      dispatch(loginWithEmailOTP(email));
    }
  };
  ...
  useEffect(() => {
    if (user) {
      ...
      loginStatus ?? setIsloading(false);
    }
  }, [user, loginStatus, router]);
    ...
    <>
      {isLoading ? (
        ...
        <>
          <Head>
            <title>Login</title>
            {/* <meta name="description" content="Awesome Polka Login Page   " /> */}
            <meta
              name="viewport"
          ...
          <section className="relative bg-white overflow-hidden">
            ...
            <div className="z-10 flex flex-wrap h-screen">
                        ...
                        <ul className="md:max-w-xs">
                          <li className="mb-5 flex flex-wrap">
                            ...
                            <span className="flex-1 font-medium leading-relaxed">
                              The best you can do in no time at all, amazing
                              feature goes here
                            </span>
                          </li>
                          <li className="mb-5 flex flex-wrap">
                            ...
                            <span className="flex-1 font-medium leading-relaxed">
                              24/7 Support of our dedicated, highly professional
                              team
                            </span>
                          </li>
                        </ul>
              ...
              <div className="w-full md:w-1/2">
                <div className="p-4 py-16 flex flex-col justify-center bg-blue-100 h-full">
