    ...
    <>
      <section className="container max-w-8xl mx-auto mt-7">
        <div className="flex space-x-8">
                            ...
                            <div className="flex">
                              ...
                              <div className="ml-3">
                                ...
                                <div className="mt-2 text-sm text-yellow-700">
                                  <p>
                                    You can connect your GitHub repository to
                                    get a detailed activity report on your
                                    project.
                                  </p>
                                </div>
                              </div>
          ...
          <div className="w-1/3">
            <div className="border-[3px] border-indigo-900 rounded-lg px-12 py-12 bg-white">
              <Image
                src="https://pbs.twimg.com/profile_banners/988470305193713665/1621972882/1500x500"
                alt={"bg"}
