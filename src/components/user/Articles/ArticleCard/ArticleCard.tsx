  ...
  return (
    <div className="bg-white border-4 border-indigo-900 shadow-md rounded-2xl overflow-hidden">
      ...
      <div className="px-6 py-8 md:p-10 border-t-4 border-indigo-900">
        ...
        <p className="text-lg md:text-xl font-bold text-orange-400 mb-2">
          {hits.date}
        </p>
        <h2 className="text-xl md:text-2xl font-extrabold mb-4 md:mb-6 leading-8 md:h-[4rem] overflow-hidden">
          {hits.title}
        </h2>
        <p className="text-md md:text-lg mb-6 leading-7 md:min-h-[7rem] max-h-[7rem] overflow-hidden">
          {hits.description}
        </p>
        <Link
