            ...
            <div className="container px-4">
              <div className="block">
                ...
                <p className="mb-8 md:mb-12 text-gray-600 font-medium leading-relaxed">
                  Search, find and apply to job opportunities at Polkadot
                  Protocol.
                </p>
              </div>
              <div className=" mx-auto">
                <div className="flex flex-wrap -m-1.5">
                  <div className="w-full p-1.5">
                    <a
                      className="group"
                      href="https://boards.greenhouse.io/parity/jobs/4988043003"
                      target="blank"
                    >
                        ...
                        <div className="flex flex-wrap justify-between items-center -m-2">
                          <div className="w-auto p-2">
                            ...
                            <h3 className="mb-2.5 text-xl font-bold font-heading leading-snug">
                              TypeScript Toolkit Engineer - Apps Framework
                            </h3>
                  ...
                  <div className="w-full p-1.5">
                    <a
                      className="group"
                      href="https://boards.greenhouse.io/parity/jobs/5480288003"
                      target="blank"
                    >
                      <div className="p-5 h-full bg-white border group-hover:border-gray-300 rounded-xl">
                        <div className="flex flex-wrap justify-between items-center -m-2">
                  ...
                  <div className="w-full p-1.5">
                    <a
                      className="group"
                      href="https://boards.greenhouse.io/parity/jobs/5428546003"
                      target="blank"
                    >
                      <div className="p-5 h-full bg-white border group-hover:border-gray-300 rounded-xl">
                        <div className="flex flex-wrap justify-between items-center -m-2">
                          <div className="w-auto p-2">
                            ...
                            <h3 className="mb-2.5 text-xl font-bold font-heading leading-snug">
                              Senior Executive Assistant (Leadership Team)
                            </h3>
                            <p className="text-sm text-gray-600 font-medium">
                              <span>Cambridge, England / United Kingdom </span>
                              <span className="px-2">•</span>
                              <span>Full Time</span>
                            </p>
                          </div>
                  ...
                  <div className="w-full p-1.5">
                    <a
                      className="group"
                      href="https://web3.bamboohr.com/jobs/view.php?id=105&source=bamboohr"
                      target="blank"
                    >
                      <div className="p-5 h-full bg-white border group-hover:border-gray-300 rounded-xl">
                        <div className="flex flex-wrap justify-between items-center -m-2">
